...
<body>
    ...
    $fnameErr = $lnameErr = $fanameErr = $manameErr = $genderErr = $bloodGroupErr = $religionErr = $emailErr = $phoneNumberErr = $websiteErr = $userNameErr = $passwordErr = $confirmPasswordErr = "";

    $fname = $lname = $faname = $maname = $gender = $bloodGroup = $religion = $email = $phoneNumber = $website = $userName = $password = $confirmPassword = "";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if (empty($_POST["faname"])) {
            $fanameErr = "Father Name is empty";
          } else {
        ...
        if (empty($_POST["maname"])) {
            $manameErr = "Mother Name is empty";
          } else {
            $maname = sanitize($_POST["maname"]);
          }
        ...
        if (empty($_POST["confirmPassword"])) {
            $confirmPasswordErr = "Confirm Password is empty";
          }
          ...
          $flag = true;
          if($flag === true){
            header("Location: Welcome.html?q1=" .$fname);
          }
    ...
    <form method="post" enctype="" novalidate action="
    <?php
                        ...
                        <tr>
                            <td>
                              ...
                              <label for = "BloodGroup"><b>Blood Group&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;&nbsp;</label>
                               ...
                               <select name="Religion" id="Religion" aria-placeholder="Religion">
                            ...
                            <td>
                              <br>  <label for="image"><b>Select image: </b></label><br>
                       ...
                       <table>
                        <tr >
                            ...
                            <fieldset>
                                ...
                                <select name="Country" id="Country"  placeholder="Country Name">
                                ...
                                <select name="City" id="City" aria-placeholder="City Name" >
